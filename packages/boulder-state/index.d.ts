...
export declare function readCurrentTopLevelTask(
  planPath: string,
...
export declare function addBoulderWork(
  directory: string,
...
export declare function completeBoulder(
  directory: string,
  workId?: string,
  endedAt?: string,
): BoulderState | null;
...
export declare function getBoulderWorks(
  state: BoulderState,
): BoulderWorkState[];
...
export declare function getTaskSessionState(
  directory: string,
  taskKey: string,
): TaskSessionState | null;
export declare function getWorkById(
  directory: string,
  workId: string,
...
export declare function getWorkForSession(
  directory: string,
  sessionId: string,
): BoulderWorkState | null;
export declare function getWorkResumeOptions(
  directory: string,
): BoulderWorkResumeOption[];
export declare function normalizeSessionId(
  sessionId: string,
  platform?: "codex" | "opencode" | "senpi",
): string;
export declare function readBoulderState(
  directory: string,
): BoulderState | null;
...
export declare function selectActiveWork(
  directory: string,
  workId: string,
): BoulderState | null;
export declare function startTaskTimer(
  directory: string,
  workId: string,
  input: TaskTimerInput,
): BoulderState | null;
export declare function upsertTaskSessionState(
  directory: string,
...
export declare function writeBoulderState(
  directory: string,
  state: BoulderState,
): boolean;
