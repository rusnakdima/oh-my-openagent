...
export function makeRecord(overrides: RecordOverrides = {}): TaskRecord {
  ...
  return {
    ...
    ...(overrides.resolved_model === undefined
      ? {}
      : { resolved_model: overrides.resolved_model }),
    ...(overrides.agent_type !== undefined
    ...
    ...(overrides.child_session_id !== undefined
      ? { child_session_id: overrides.child_session_id }
      : {}),
    ...(overrides.final_response !== undefined
      ? { final_response: overrides.final_response }
      : {}),
    ...(overrides.error_message !== undefined
