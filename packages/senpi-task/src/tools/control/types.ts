...
export type CallerSessionResolver = (
  ctx: SessionIdCarrier,
) => string | undefined;
...
export type SendResultDetails =
  ...
  | {
    readonly kind: "not_continuable";
    readonly task_id: string;
    readonly reason: string;
    readonly suggestion: string;
  }
  | {
    readonly kind: "one_shot_agent";
    readonly task_id: string;
