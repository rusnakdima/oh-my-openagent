...
export function buildRecordInput(input: {
  ...
  return {
    ...
    ...(plan.toolAllowlist !== undefined
      ? { tool_allow: plan.toolAllowlist }
      : {}),
    ...(plan.toolDenylist !== undefined
      ? { tool_deny: plan.toolDenylist }
      : {}),
  };
}
...
export function promotedBackgroundMode(record: TaskRecord): BackgroundMode {
  if (record.background_mode !== undefined) {
    return record.background_mode === "foreground"
      ? "promoted"
...
export function buildManagedSpec(input: {
  ...
  const prompt = plan.promptAppend
    ? `${spec.prompt}\n\n${plan.promptAppend}`
    : spec.prompt;
  ...
  return {
    ...
    ...(plan.fallback_models !== undefined
      ...
      : {}),
    ...(plan.resolved_model !== undefined
      ? { resolvedModel: plan.resolved_model }
      : {}),
    ...
    ...(plan.toolAllowlist !== undefined
      ...
      : {}),
    ...(record.tool_deny !== undefined
      ? { toolDenylist: record.tool_deny }
      : {}),
    ...(spec.memberScopedTools !== undefined
      ? { memberScopedTools: spec.memberScopedTools }
      : {}),
    ...(spec.memberScopedTools !== undefined
      ? {
...
export type BuildRespawnManagedSpecResult =
  ...
  | {
    readonly ok: false;
    readonly code: "spawn_spec_unavailable";
...
export function buildRespawnManagedSpec(
  record: TaskRecord,
  stateDir: string,
): BuildRespawnManagedSpecResult {
  ...
  return {
    ...
    spec: {
      ...
      ...(record.fallback_models !== undefined
        ? { fallbackModels: record.fallback_models }
        : {}),
      ...
      ...(record.resolved_model?.variant === undefined
        ? {}
        : { variant: record.resolved_model.variant }),
      ...(record.agent_type !== undefined
        ? { agentType: record.agent_type }
        : {}),
      ...(spawnSpec.instructions !== undefined
        ? { instructions: spawnSpec.instructions }
        : {}),
      ...(record.tool_allow !== undefined
        ? { toolAllowlist: record.tool_allow }
        : {}),
      ...(record.tool_deny !== undefined
        ? { toolDenylist: record.tool_deny }
        : {}),
...
export function inSession(record: TaskRecord, sessionId: string): boolean {
  return record.parent_session_id === sessionId ||
...
export function recordSpawnedPid(
  record: TaskRecord,
