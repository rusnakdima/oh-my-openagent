...
async function resolveSpawnTmuxWindowDeps(
  deps?: Partial<SpawnTmuxWindowDeps>,
): Promise<SpawnTmuxWindowDeps> {
...
export async function spawnTmuxWindow(
  ...
  log("[spawnTmuxWindow] SUCCESS", {
    paneId,
    windowName: ISOLATED_WINDOW_NAME,
  });
