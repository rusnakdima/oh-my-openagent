...
export function isPluginEnabled(
  ...
  if (
    isEnabledPluginsRecord(overrideEnabledPlugins) &&
    pluginKey in overrideEnabledPlugins
  ) {
  ...
  if (
    isEnabledPluginsRecord(settingsEnabledPlugins) &&
    pluginKey in settingsEnabledPlugins
  ) {
...
function isEnabledPluginsRecord(
  value: unknown,
