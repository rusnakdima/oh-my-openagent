...
export const MAIN_SCRIPT = {
  ...
  parentSteps: [
    ...
    { type: "text", text: "parent turn one done, going idle" },
    {
      type: "tool_call",
      name: "task_send",
      arguments: { to: "e2echild", message: "do the second unit" },
    },
    {
      type: "tool_call",
      name: "task_output",
      arguments: { name: "e2echild", mode: "tail" },
    },
...
export const BATCH_SCRIPT = {
  childSteps: [{ type: "text", text: `${BATCH_FINAL} one` }, {
    type: "text",
    text: `${BATCH_FINAL} two`,
  }],
  parentSteps: [
    {
      type: "tool_call",
