...
const defaultBaseDir = fileURLToPath(
  new URL("../runtime/agent-toolkit", import.meta.url),
);

export function createToolkitPathProvisioning(
  options: ToolkitPathProvisioningOptions = {},
): () => void {
