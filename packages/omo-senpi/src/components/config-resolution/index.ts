...
export type SenpiConfigDiagnostic =
  | OmoConfigDiagnostic
  | OmoModelReferenceDiagnostic;

export type SenpiOmoConfigResult =
  & Omit<LoadOmoConfigResult, "config" | "diagnostics">
  & {
...
export function loadSenpiOmoConfig(
