 ...
 */
export function resolveSessionModelRegistry(
  eventCtx: unknown,
): TaskModelRegistry | undefined {
  ...
  if (typeof getAvailable !== "function" || typeof find !== "function") {
    return undefined;
  }
  return {
    getAvailable: () => Reflect.apply(getAvailable, registry, []),
    find: (provider, modelId) =>
      Reflect.apply(find, registry, [provider, modelId]),
  };
}
