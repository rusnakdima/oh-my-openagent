...
export function createSenpiTelemetryComponent(
  options: SenpiTelemetryOptions = {},
): OmoSenpiComponent {
  return {
    name: "telemetry",
...
function createRecordDailyActiveInput(
  options: SenpiTelemetryOptions,
