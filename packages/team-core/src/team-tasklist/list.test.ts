...
test(
  "listTasks returns tasks sorted ascending and honors filters",
  async () => {
    // given
    ...
    try {
      ...
      const claimedTasks = await listTasks(fixture.teamRunId, fixture.config, {
        status: "claimed",
        owner: "member-a",
      });
