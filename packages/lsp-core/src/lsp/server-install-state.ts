...
export function loadInstallDecision(
  serverId: string,
): InstallDecisionRecord | undefined {
...
function isInstallDecisionRecord(
  value: unknown,
): value is InstallDecisionRecord {
  if (!isRecord(value)) return false;
  return isInstallDecision(value["decision"]) &&
