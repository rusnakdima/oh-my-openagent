...
export interface RunCodegraphSweepCliOptions
  extends SweepCodegraphZombiesOptions {
...
export async function runCodegraphSweepCli(
  options: RunCodegraphSweepCliOptions = {},
): Promise<number> {
...
function writeSweepReport(
  stdout: HookStdout,
  result: SweepCodegraphZombiesResult,
): void {
  stdout.write(`${
    JSON.stringify({
