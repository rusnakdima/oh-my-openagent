...
export type SessionStartLockResult =
  | {
    ...
    readonly lock: SessionStartLock;
...
export function acquireSessionStartLock(
...
function reclaimStaleLock(
  ...
  try {
    ...
    if (current.kind === "present") {
      const changed = current.raw !== staleSnapshot.raw ||
        current.mtimeMs !== staleSnapshot.mtimeMs;
