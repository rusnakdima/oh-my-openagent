...
import {
  runCodegraphSweepCli,
  type RunCodegraphSweepCliOptions,
} from "./sweep-cli.js";
...
type SweepCodegraphZombiesTestOptions = Omit<
  RunCodegraphSweepCliOptions,
  "argv" | "env" | "stdout"
>;

export async function runCodegraphCli(
  options: RunCodegraphCliOptions = {},
): Promise<number> {
