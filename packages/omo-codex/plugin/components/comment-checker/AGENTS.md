...
- `node dist/cli.js hook post-tool-use < fixture.json` - smoke-test the Codex
  hook.
...
- `apply_patch` must support Codex `tool_input.command`, raw patch text, and
  OMO-compatible metadata.
