...
export type UlwLoopSteeringMutationKind =
  (typeof ULW_LOOP_STEERING_MUTATION_KINDS)[number];
...
export type UlwLoopCriterionStatus =
  (typeof ULW_LOOP_CRITERION_STATUSES)[number];
...
export type UlwLoopLedgerEventKind =
  (typeof ULW_LOOP_LEDGER_EVENT_KINDS)[number];
