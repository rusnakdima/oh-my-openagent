...
export function normalizeUlwLoopSessionId(
...
export function resolveUlwLoopSessionIdFromEnv(
...
export function ulwLoopBriefPath(
  repoRoot: string,
  scope?: UlwLoopScope,
): string {
...
export function ulwLoopGoalsPath(
  repoRoot: string,
  scope?: UlwLoopScope,
): string {
...
export function ulwLoopLedgerPath(
  repoRoot: string,
  scope?: UlwLoopScope,
): string {
...
export function ulwLoopAttemptEvidenceDir(
  ...
  const sessionId = normalizeUlwLoopSessionId(scope?.sessionId) ??
    resolveUlwLoopSessionIdFromEnv() ?? "session";
