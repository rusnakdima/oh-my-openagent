    ...
    adversarialCases: [
      {
        ...
        expectedBehavior:
          "validator rejects the section-specific role mismatch",
        verdict: "passed",
    ...
    const cases = [
      {
        field: "codeReview.by",
        input: gateWith({
          codeReview: { ...BASE_GATE.codeReview, by: "senior-reviewer" },
        }),
      },
      {
        field: "manualQa.by",
        input: gateWith({
          manualQa: { ...BASE_GATE.manualQa, by: "qa-person" },
        }),
      },
      {
        field: "gateReview.by",
        input: gateWith({
          gateReview: { ...BASE_GATE.gateReview, by: "release-manager" },
        }),
      },
    ] as const;
    ...
    const cases = [
      {
        field: "codeReview.by",
        input: gateWith({
          codeReview: { ...BASE_GATE.codeReview, by: "lazycodex-qa-executor" },
        }),
      },
      {
        field: "manualQa.by",
        input: gateWith({
          manualQa: { ...BASE_GATE.manualQa, by: "lazycodex-gate-reviewer" },
        }),
      },
      {
        field: "gateReview.by",
