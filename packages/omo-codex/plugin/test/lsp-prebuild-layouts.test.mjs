...
const REPO_SCRIPTS = fileURLToPath(
  new URL("../components/lsp/scripts", import.meta.url),
);
...
test("#given the installed cache layout #when running build-lsp-tools #then uses the bundled dist and exits 0", async () => {
  ...
  try {
    ...
    await mkdir(join(root, "components", "lsp-tools-mcp", "dist", "lsp"), {
      recursive: true,
    });
    await writeFile(
      join(root, "components", "lsp-tools-mcp", "dist", "cli.js"),
      "",
    );
    await writeFile(
      join(root, "components", "lsp-tools-mcp", "dist", "tools.js"),
      "",
    );
    await writeFile(
      join(root, "components", "lsp-tools-mcp", "dist", "lsp", "manager.js"),
      "",
    );
...
test("#given the installed cache layout #when running build-lsp-daemon #then uses the bundled dist and exits 0", async () => {
  ...
  try {
    ...
    await mkdir(join(root, "components", "lsp-daemon", "dist"), {
      recursive: true,
    });
    await writeFile(
      join(root, "components", "lsp-daemon", "dist", "cli.js"),
      "",
    );
    await writeFile(
      join(root, "components", "lsp-daemon", "dist", "client.js"),
      "",
    );
    await writeFile(
      join(root, "components", "lsp-daemon", "dist", "client.d.ts"),
      "",
    );
    await writeFile(
      join(root, "components", "lsp-daemon", "dist", "index.js"),
      "",
    );
    await writeFile(
      join(root, "components", "lsp-daemon", "dist", "index.d.ts"),
      "",
    );
