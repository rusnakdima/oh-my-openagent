...
export const codexHarnessToolCompatibility =
...
function findCodexCompatibilitySectionEnd(content, searchStart) {
  ...
  const knownEndMarker = codexCompatibilityEndMarkers.find((marker) =>
...
function hasKnownGeneratedCodexCompatibilityGuidance(
  ...
  return codexCompatibilityEndMarkers.some((marker) =>
