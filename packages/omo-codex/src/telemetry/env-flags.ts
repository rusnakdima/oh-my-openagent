...
export function getPostHogApiKey(): string {
  return getTelemetryApiKey(
    process.env,
    createCodexTelemetryProductConfig().defaultApiKey,
  );
}

export function hasPostHogApiKey(): boolean {
  return hasTelemetryApiKey(
    process.env,
    createCodexTelemetryProductConfig().defaultApiKey,
  );
}
...
export function getPostHogHost(): string {
  return getTelemetryHost(
    process.env,
    createCodexTelemetryProductConfig().defaultHost,
  );
}
