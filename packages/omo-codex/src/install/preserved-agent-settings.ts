...
import {
  type PreservedAgentReasoning,
  resolveManagedAgentReasoning,
} from "./managed-agent-reasoning-defaults";
...
function extractTopLevelStringSetting(
  content: string,
  key: string,
): string | null {
...
function topLevelStringSettingRawValue(
  line: string,
  key: string,
): string | undefined {
