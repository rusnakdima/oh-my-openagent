...
export async function findMissingHookCommandTargets(
  pluginRoot: string,
...
async function hookManifestPaths(
  pluginRoot: string,
): Promise<readonly string[]> {
