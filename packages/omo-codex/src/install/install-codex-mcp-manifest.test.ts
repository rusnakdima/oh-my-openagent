...
describe("install-codex MCP manifest", () => {
  test(
    "#given codex installer #when installing omo #then caches research MCPs without ast-grep MCP",
    async () => {
      // given
