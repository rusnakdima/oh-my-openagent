...
export type LazyCodexDelegatedCommand = Extract<
...
export function buildDelegatedOmoInvocation(
  parsed: LazyCodexDelegatedCommand,
...
function buildLazyCodexDoctorInvocation(
...
function parseLazyCodexDoctorOptions(
  doctorArgs: readonly string[],
): LazyCodexDoctorOptions {
  const args: string[] = [];
