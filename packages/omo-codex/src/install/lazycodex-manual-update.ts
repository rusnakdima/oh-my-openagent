...
const KNOWN_LAZYCODEX_BUN_TRUST_PREFIXES = [
  "@oh-my-opencode/",
  "oh-my-openagent-",
  "oh-my-opencode-",
] as const;
...
type LazyCodexUpdatePlan =
  | {
    readonly shouldUpdate: false;
    readonly reason: "unknown-current" | "unknown-latest" | "up-to-date";
  }
  | {
    readonly shouldUpdate: true;
    readonly command: string;
    readonly args: readonly string[];
    readonly postUpdate: "bun-global-trust" | "none";
  };
...
async function confirmBunGlobalTrust(
...
function isBunGlobalEntrypoint(
...
function defaultRunCommandForManualUpdate(
  command: string,
