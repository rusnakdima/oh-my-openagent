...
export const OmoGitMasterSettingsLayerSchema = z.object(
  OmoGitMasterSettingsShape,
).partial().strict();

export const OmoGitMasterSettingsSchema = OmoGitMasterSettingsLayerSchema
  .extend({
...
export type OmoGitMasterSettingsLayer = z.infer<
  typeof OmoGitMasterSettingsLayerSchema
>;
...
export const GIT_MASTER_HARNESS_SUPPORT: Record<
  GitMasterSettingPath,
...
export function resolveOmoGitMasterSettings(
  config: OmoGitMasterConfigView,
): OmoGitMasterSettings {
