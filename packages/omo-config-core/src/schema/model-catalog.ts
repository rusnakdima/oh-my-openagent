...
export const OmoModelCatalogSchema = z.record(
  z.string(),
  OmoModelCatalogEntrySchema,
);

const OmoModelCatalogEntryLayerInputSchema = OmoModelCatalogEntryInputSchema
  .partial();
export const OmoModelCatalogEntryLayerSchema = z.preprocess(
  (value) => isRecord(value) ? normalizeLegacyModelFields(value) : value,
  OmoModelCatalogEntryLayerInputSchema,
);
export const OmoModelCatalogLayerSchema = z.record(
  z.string(),
  OmoModelCatalogEntryLayerSchema,
);
...
export type OmoModelCatalogEntryLayer = z.infer<
  typeof OmoModelCatalogEntryLayerSchema
>;
