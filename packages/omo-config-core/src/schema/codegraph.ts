...
export const OmoCodegraphSettingsLayerSchema = z.object(
  OmoCodegraphSettingsShape,
).partial().strict();

export const OmoCodegraphSettingsSchema = OmoCodegraphSettingsLayerSchema
  .extend({
...
export type OmoCodegraphSettingsLayer = z.infer<
  typeof OmoCodegraphSettingsLayerSchema
>;
...
export const SETTING_HARNESS_SUPPORT: Record<
  SettingPath,
  readonly HarnessId[]
> = {
