...
export const LANGUAGES: readonly LanguageServer[] = [
  ...
  },
  {
    ...
    extensions: [".java"],
    installHint:
      "macOS: brew install jdtls | https://github.com/eclipse-jdtls/eclipse.jdt.ls",
  },
  {
    language: "kotlin",
    serverId: "kotlin-ls",
  ...
  },
  {
    ...
    installHint:
      "Included with Xcode (xcode-select --install) or the Swift toolchain",
  },
  {
    language: "ruby",
    serverId: "ruby-lsp",
    ...
    installHint:
      "gem install ruby-lsp (builtin runs `rubocop --lsp`; gem install rubocop)",
  },
  {
    language: "php",
    serverId: "php",
  ...
  },
  {
    ...
    extensions: [".zig", ".zon"],
    installHint:
      "https://github.com/zigtools/zls (match zls version to your zig version)",
  },
  {
    language: "lua",
    serverId: "lua-ls",
