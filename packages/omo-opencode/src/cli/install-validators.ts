...
export function formatConfigSummary(config: InstallConfig): string {
  ...
  if (config.hasCodex) {
    lines.push(
      `  ${SYMBOLS.info} Codex autonomous mode: ${
        config.codexAutonomous ? "enabled" : "disabled"
      }`,
    );
  }
  if (config.hasSenpi) {
  ...
  lines.push(
    `  ${SYMBOLS.bullet} Priority: Native > Copilot > OpenCode Zen > Z.ai > Kimi > Bailian > MiniMax > Vercel`,
  );
...
export function validateNonTuiArgs(
  ...
  if (hasOpenCode && args.claude === undefined) {
    ...
    args.claude !== undefined && !["no", "yes", "max20"].includes(args.claude)
  ) {
    errors.push(
  ...
  if (hasOpenCode && args.gemini === undefined) {
    ...
    args.gemini !== undefined && !["no", "yes"].includes(args.gemini)
  ) {
  ...
  if (hasOpenCode && args.copilot === undefined) {
    ...
    args.copilot !== undefined && !["no", "yes"].includes(args.copilot)
  ) {
  ...
  if (
    args.opencodeGo !== undefined && !["no", "yes"].includes(args.opencodeGo)
  ) {
    errors.push(
  ...
  if (
    args.opencodeZen !== undefined && !["no", "yes"].includes(args.opencodeZen)
  ) {
    errors.push(
  ...
  if (
    args.bailianCodingPlan !== undefined &&
    !["no", "yes"].includes(args.bailianCodingPlan)
  ) {
    errors.push(
      `Invalid --bailian-coding-plan value: ${args.bailianCodingPlan} (expected: no, yes)`,
    );
  }

  if (
    args.minimaxCnCodingPlan !== undefined &&
    !["no", "yes"].includes(args.minimaxCnCodingPlan)
  ) {
    errors.push(
      `Invalid --minimax-cn-coding-plan value: ${args.minimaxCnCodingPlan} (expected: no, yes)`,
    );
  }

  if (
    args.minimaxCodingPlan !== undefined &&
    !["no", "yes"].includes(args.minimaxCodingPlan)
  ) {
    errors.push(
      `Invalid --minimax-coding-plan value: ${args.minimaxCodingPlan} (expected: no, yes)`,
    );
  }
...
function collectCodexOnlyOpenCodeFlagErrors(args: InstallArgs): string[] {
  ...
  if (args.claude !== undefined) {
    errors.push("--claude cannot be used with --platform=codex");
  }
  if (args.openai !== undefined) {
    errors.push("--openai cannot be used with --platform=codex");
  }
  if (args.gemini !== undefined) {
    errors.push("--gemini cannot be used with --platform=codex");
  }
  if (args.copilot !== undefined) {
    errors.push("--copilot cannot be used with --platform=codex");
  }
  if (args.opencodeZen !== undefined) {
    errors.push("--opencode-zen cannot be used with --platform=codex");
  }
  if (args.zaiCodingPlan !== undefined) {
    errors.push("--zai-coding-plan cannot be used with --platform=codex");
  }
  if (args.kimiForCoding !== undefined) {
    errors.push("--kimi-for-coding cannot be used with --platform=codex");
  }
  if (args.opencodeGo !== undefined) {
    errors.push("--opencode-go cannot be used with --platform=codex");
  }
  if (args.bailianCodingPlan !== undefined) {
    errors.push("--bailian-coding-plan cannot be used with --platform=codex");
  }
  if (args.minimaxCnCodingPlan !== undefined) {
    errors.push(
      "--minimax-cn-coding-plan cannot be used with --platform=codex",
    );
  }
  if (args.minimaxCodingPlan !== undefined) {
    errors.push("--minimax-coding-plan cannot be used with --platform=codex");
  }
  if (args.vercelAiGateway !== undefined) {
    errors.push("--vercel-ai-gateway cannot be used with --platform=codex");
  }
  return errors;
}
