...
function flattenConfiguredModels(
  result: ReturnType<typeof generateModelConfig>,
) {
  return [
...
describe("generateModelConfig", () => {
  describe("fallback providers", () => {
    test("downgrades unsupported GitHub Copilot GPT high-tier variants", () => {
      ...
      expect(result.categories?.ultrabrain?.model).toBe(
      ...
      expect(result.categories?.["unspecified-low"]?.model).toBe(
