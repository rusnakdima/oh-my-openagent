...
function describeResult(
  result: Awaited<ReturnType<RunAstGrepSkillInstall>>,
): string | null {
...
export async function installAstGrepForOpenCode(
  options: OpenCodeAstGrepInstallOptions = {},
): Promise<void> {
  ...
  const skillDir = join(
    options.sharedSkillsRoot ?? sharedSkillsRootPath(),
    "ast-grep",
  );
