...
export function resolveCallerTeamLead(
  ...
  const displayName = isStructuredDisplayName &&
      strippedDisplayName.toLowerCase() === canonicalDisplayName.toLowerCase()
...
export function shouldReuseCallerLeadSession(
  spec: TeamSpec,
  callerAgentTypeId: string | undefined,
): boolean {
