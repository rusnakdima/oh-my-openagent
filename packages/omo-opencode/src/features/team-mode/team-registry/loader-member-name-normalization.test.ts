...
describe("loadTeamSpec member name normalization", () => {
  ...
  test("auto-assigns missing member names for specs on disk", async () => {
      ...
      members: [
        {
          kind: "category",
          category: "quick",
          prompt: "Quick scout the workspace structure.",
        },
        {
          kind: "category",
          category: "deep",
          prompt: "Deep dive the runtime setup.",
        },
        {
          kind: "category",
          category: "deep",
          prompt: "Deep dive the mailbox implementation.",
        },
    ...
    expect(teamSpec.members.map((member) => member.name)).toEqual([
      "lead",
      "quick-1",
      "deep-1",
      "deep-2",
