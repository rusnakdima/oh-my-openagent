...
let createMonitorManagerOptions:
  | Parameters<typeof createMonitorManager>[0]
  | undefined;
...
const createMonitorManagerFn = mock(
  (options: Parameters<typeof createMonitorManager>[0]) => {
