...
import {
  type CodegraphMcpConfigOptions,
...
export function createBuiltinMcps(
  ...
  if (
    !disabledMcps.includes("codegraph") && config?.codegraph?.enabled !== false
  ) {
  ...
  if (
    !disabledMcps.includes("openspec") && config?.openspec?.enabled === true
  ) {
