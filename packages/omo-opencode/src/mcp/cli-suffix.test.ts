...
describe("hasCliSuffix", () => {
  it("matches cli suffixes across platform separators", () => {
    ...
    // when
    const results = candidatePaths.map((candidatePath) =>
      hasCliSuffix(candidatePath, suffix)
    );
  ...
  it("does not match unrelated cli suffixes", () => {
    // given
    const candidatePath =
      "C:\\Users\\yeongyu\\project\\packages\\other-mcp\\dist\\cli.js";

    // when
    const result = hasCliSuffix(
      candidatePath,
  ...
  it("matches a package dist cli suffix on Windows path separators", () => {
    // given
    const windowsPath =
      "C:\\Users\\test\\AppData\\Local\\cache\\oh-my-opencode\\dist\\packages\\lsp-tools-mcp\\dist\\cli.js";
    ...
    const matchesPackageSuffix = hasCliSuffix(
      windowsPath,
      "packages/lsp-tools-mcp/dist/cli.js",
    );
