    ...
    const text = extractLatestAssistantText([
      {
        ...
        parts: [{
          type: "reasoning",
          text: "<answer>Detected two warning symbols.</answer>",
        }],
      },
    ]);
    ...
    const text = extractLatestAssistantText([
      {
        ...
        parts: [{
          type: "text",
          text: "",
          reasoning_content: "<answer>There are three columns.</answer>",
        }],
      },
    ]);
    ...
    const text = extractLatestAssistantText([
      {
        ...
        parts: [{
          ...
          content: [{
            type: "text",
            text: "<answer>Structured answer</answer>",
          }],
        }],
      },
    ]);
