...
beforeEach(() => {
  ...
  clearRequireCache(
    "../../../../../skills-loader-core/src/features/opencode-skill-loader/skill-content",
  );
  clearRequireCache(
    "../../../../../skills-loader-core/src/features/opencode-skill-loader/loaded-skill-template-extractor",
  );
