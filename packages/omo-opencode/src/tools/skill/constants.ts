...
export const TOOL_DESCRIPTION_NO_SKILLS =
  "Load a skill or execute a slash command to get detailed instructions for a specific task. No skills are currently available.";

export const TOOL_DESCRIPTION_PREFIX =
