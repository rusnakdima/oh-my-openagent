...
describe("sisyphus-task-retry", () => {
  ...
  describe("detectDelegateTaskError", () => {
    ...
    it("should detect run_in_background missing error", () => {
      const output =
        "[ERROR] Invalid arguments: 'run_in_background' parameter is REQUIRED. Use run_in_background=false for task delegation.";
    ...
    it("should detect load_skills missing error", () => {
      const output =
        "[ERROR] Invalid arguments: 'load_skills' parameter is REQUIRED. Use load_skills=[] if no skills are needed.";
    ...
    it("should detect unknown category error", () => {
      const output =
        '[ERROR] Unknown category: "invalid-cat". Available: visual-engineering, ultrabrain, quick';
    ...
    it("should detect unknown agent error", () => {
      const output =
        '[ERROR] Unknown agent: "fake-agent". Available agents: explore, librarian, oracle';
  ...
  describe("buildRetryGuidance", () => {
    ...
    it("should provide fix for unknown category with available list", () => {
      const errorInfo = {
        ...
        originalOutput:
          '[ERROR] Unknown category: "bad". Available: visual-engineering, ultrabrain',
      };
    ...
    it("should provide fix for unknown agent with available list", () => {
      const errorInfo = {
        ...
        originalOutput:
          '[ERROR] Unknown agent: "fake". Available agents: explore, oracle',
      };
