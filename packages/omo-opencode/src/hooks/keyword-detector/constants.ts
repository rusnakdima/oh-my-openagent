...
import { OPENSPEC_PATTERN, OPENSPEC_MESSAGE } from "./openspec"
...
export { OPENSPEC_PATTERN, OPENSPEC_MESSAGE }
...
// Analyze keyword
export const ANALYZE_PATTERN = /\b(analyze|analysis|examine|investigate|assess|evaluate)\b/i
...
// Refactor keyword
export const REFACTOR_PATTERN = /\b(refactor|restructure|reorganize|improve|rethink)\b/i
...
// Test keyword
export const TEST_PATTERN = /\b(test|testing|tests|unittest|pytest|test suite)\b/i
