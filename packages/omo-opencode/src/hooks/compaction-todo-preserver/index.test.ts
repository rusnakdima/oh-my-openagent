...
describe("compaction-todo-preserver", () => {
  ...
  it("restores detailed todos when only Atlas bootstrap todos are present after compaction", async () => {
    ...
    const detailedTodos: Todo[] = [
      {
        content: "Inspect runtime compaction state",
        status: "completed",
        priority: "high",
      },
      {
        content: "Add regression coverage for todo preservation",
        status: "in_progress",
        priority: "high",
      },
      {
        content: "Run focused tests and open PR",
        status: "pending",
        priority: "medium",
      },
    ];
  ...
  it("skips restore when current todos include meaningful post-compaction work", async () => {
    ...
    const currentTodos: Todo[] = [
      ...
      {
        content: "Review post-compaction findings",
        status: "pending",
        priority: "medium",
      },
    ];
  ...
  it("does not restore a stale snapshot after a later empty capture", async () => {
    ...
    const oldTodos: Todo[] = [
      {
        content: "Old task that no longer exists",
        status: "pending",
        priority: "high",
      },
    ];
  ...
  it("does not restore a stale snapshot after a later failed capture", async () => {
    ...
    const oldTodos: Todo[] = [
      {
        content: "Old task that should not come back",
        status: "pending",
        priority: "high",
      },
    ];
  ...
  it("does not retain a stale snapshot when Todo.update is unavailable", async () => {
    ...
    const detailedTodos: Todo[] = [
      {
        content: "Detailed task before missing writer",
        status: "in_progress",
        priority: "high",
      },
    ];
  ...
  it("protects detailed current todos from a later Atlas bootstrap write after compaction", async () => {
    ...
    const detailedTodos: Todo[] = [
      {
        content: "Keep detailed task one",
        status: "in_progress",
        priority: "high",
      },
      {
        content: "Keep detailed task two",
        status: "pending",
        priority: "medium",
      },
    ];
  ...
  it("clears late bootstrap protection when the session idles", async () => {
    ...
    const detailedTodos: Todo[] = [
      {
        content: "Detailed task before idle",
        status: "in_progress",
        priority: "high",
      },
    ];
  ...
  it("clears a pending snapshot when the session idles before restore", async () => {
    ...
    const detailedTodos: Todo[] = [
      {
        content: "Detailed task before interrupted compaction",
        status: "in_progress",
        priority: "high",
      },
    ];
