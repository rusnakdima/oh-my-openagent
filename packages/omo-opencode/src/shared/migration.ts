...
} from "@oh-my-opencode/utils/migration/agent-category";
export {
  HOOK_NAME_MAP,
  migrateHookNames,
} from "@oh-my-opencode/utils/migration/hook-names";
export {
  getSidecarPath,
  readAppliedMigrations,
  writeAppliedMigrations,
} from "@oh-my-opencode/utils/migration/migrations-sidecar";
export {
  migrateModelVersions,
  MODEL_VERSION_MAP,
} from "@oh-my-opencode/utils/migration/model-versions";
