...
describe("sweepStaleOmoAttachPanesWith", () => {
      ...
      listCandidatePanes: async () => [
        {
          ...
          attachServerUrl: "",
          commandLine:
            `/bin/sh -c "opencode attach http://127.0.0.1:4101 --session ses_dead --dir /tmp/project"`,
        },
        {
          paneId: "%live",
          ...
          attachServerUrl: "",
          commandLine:
            `opencode attach 'http://127.0.0.1:4102/' --session 'ses_live' --dir '/tmp/project'`,
        },
        {
          paneId: "%team",
          ...
          attachServerUrl: "",
          commandLine:
            `opencode attach 'http://127.0.0.1:4104/' --session 'ses_team' --dir '/tmp/project'`,
        },
        {
          paneId: "%manual",
          title: "manual-shell",
          attachServerUrl: "",
          commandLine:
            "opencode attach http://127.0.0.1:4105 --session ses_manual",
        },
        {
          paneId: "%other",
          title: "",
      ...
      listCandidatePanes: async () => [
        {
          ...
          attachServerUrl: "",
          commandLine:
            "opencode attach http://127.0.0.1:4103 --session ses_dead",
        },
      ],
      isServerRunning: async () => false,
  ...
  it("#given server health check throws for one pane #when sweep called #then later stale panes are still closed", async () => {
      ...
      listCandidatePanes: async () => [
        {
          ...
          attachServerUrl: "",
          commandLine:
            "opencode attach http://127.0.0.1:4106 --session ses_bad",
        },
        {
          paneId: "%dead",
          title: "omo-subagent-dead",
          attachServerUrl: "",
          commandLine:
            "opencode attach http://127.0.0.1:4107 --session ses_dead",
        },
      ],
      isServerRunning: async (serverUrl: string) => {
    ...
    expect(logged).toContain(
      "[sweepStaleOmoAttachPanesWith] failed to check pane server health",
    );
  });
    ...
    const deps: SweepAttachPaneDeps = {
      ...
      listCandidatePanes: async () => [
        ...
        },
        {
          ...
          attachServerUrl: "",
          commandLine:
            "opencode attach http://192.168.1.20:4108 --session ses_private",
        },
        {
          ...
          attachServerUrl: "",
          commandLine:
            "opencode attach 'https://example.org:4108/' --session ses_external",
        },
        {
          paneId: "%local",
          ...
          attachServerUrl: "",
          commandLine:
            "opencode attach http://localhost:4108 --session ses_local",
        },
      ],
      isServerRunning: async (serverUrl: string) => {
        checkedUrls.push(serverUrl);
