...
export function withPaneSpawnDeps(
  deps?: Partial<SpawnTmuxPaneDeps>,
): Partial<SpawnTmuxPaneDeps> {
  return {
    log,
    runTmuxCommand,
...
export function withPaneReplaceDeps(
  deps?: Partial<ReplaceTmuxPaneDeps>,
): Partial<ReplaceTmuxPaneDeps> {
  return {
    log,
    runTmuxCommand,
    isInsideTmux: isTmuxPaneCompatible,
...
export function withWindowSpawnDeps(
  deps?: Partial<SpawnTmuxWindowDeps>,
): Partial<SpawnTmuxWindowDeps> {
  return {
    log,
    runTmuxCommand,
    isInsideTmux,
...
export function withSessionSpawnDeps(
  deps?: Partial<SpawnTmuxSessionDeps>,
): Partial<SpawnTmuxSessionDeps> {
  return {
    log,
    runTmuxCommand,
    isInsideTmux,
