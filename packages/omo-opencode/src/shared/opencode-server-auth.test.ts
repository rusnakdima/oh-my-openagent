...
let getServerBasicAuthHeader:
  (typeof import("./opencode-server-auth"))["getServerBasicAuthHeader"];
let injectServerAuthIntoClient:
  (typeof import("./opencode-server-auth"))["injectServerAuthIntoClient"];
