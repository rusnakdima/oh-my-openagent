...
export function getBundledModelCapabilitiesSnapshotForRuntime() {
  return getBundledModelCapabilitiesSnapshot(
    bundledModelCapabilitiesSnapshotJson,
  );
}

export function getBundledModelCapabilitiesSnapshotForShared(): ReturnType<
  typeof getBundledModelCapabilitiesSnapshotForRuntime
> {
...
export function getModelCapabilities(
  ...
  return getModelCapabilitiesFromCore({
    ...input,
    bundledSnapshot: input.bundledSnapshot ??
      getBundledModelCapabilitiesSnapshotForRuntime(),
