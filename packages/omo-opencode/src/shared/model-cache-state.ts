...
import { readProviderModelsCache, type ProviderModelsCache } from "./connected-providers-cache"

// Module-level singleton for TUI access
let cachedModels: Array<{ providerID: string; modelID: string; label: string }> | null = null
 ...
 */
export function getAvailableModels(): Array<{ providerID: string; modelID: string; label: string }> {
