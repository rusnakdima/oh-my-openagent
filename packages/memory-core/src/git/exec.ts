      ...
      if (error.code === "ENOENT") {
        ...
        if (!existsSync(options.cwd)) {
          resolve({
            ...
            stdout: "",
            stderr:
              `fatal: cannot change to '${options.cwd}': No such file or directory`,
          });
          return;
        }
