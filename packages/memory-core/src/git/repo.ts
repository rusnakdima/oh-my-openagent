...
export class GitMemoryRepo {
  ...
  async worktreeAdd(
    ...
    await withSerializedGitWorktreeMutation(
      this.dir,
      () =>
        withGitLockRetry(() =>
