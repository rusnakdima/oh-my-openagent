...
export function applyMemoryPatchHunk(
  content: string,
  hunk: PatchHunk,
  filePath: string,
): string {
...
function buildOldNewChunks(
  lines: readonly string[],
): { oldChunk: string; newChunk: string } {
