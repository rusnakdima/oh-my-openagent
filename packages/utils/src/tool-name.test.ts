...
describe("transformToolName", () => {
  describe("whitespace trimming", () => {
    test.each(
      [
        [
          "trims leading whitespace from tool name",
          " delegate_task",
          "DelegateTask",
        ],
        [
          "trims trailing whitespace from tool name",
          "delegate_task ",
          "DelegateTask",
        ],
        [
        ...
        [
          "applies special mapping after trimming whitespace",
          " webfetch",
          "WebFetch",
        ],
        [
          "handles simple case with leading and trailing spaces",
          " read ",
          "Read",
        ],
      ] as const,
    )("%s", (_label, toolName, expected) => {
      // when
  ...
  describe("simple capitalization", () => {
    test.each(
      [
        ...
        [
          "preserves capitalization of already capitalized names",
          "Write",
          "Write",
        ],
      ] as const,
