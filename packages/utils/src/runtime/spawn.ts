...
type BunSpawnRuntime = {
  ...
  spawn(
    options: SpawnOptions & { readonly cmd: readonly string[] },
  ): BunSpawnedProcess;
  spawnSync(
...
function isOptionsWithCommand(
  value: unknown,
): value is SpawnOptions & { readonly cmd: readonly string[] } {
...
function resolveCommand(
  cmdOrOpts:
    | readonly string[]
    | (SpawnOptions & { readonly cmd: readonly string[] }),
...
function toSpawnSyncBuffer(
  output: Buffer | Uint8Array | string | null,
): Buffer | undefined {
