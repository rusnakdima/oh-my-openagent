...
const OMO_PROVISION_HINT =
  "Start an OMO session so the bundled ast-grep skill provisions the pinned runtime automatically";
const ENV_OVERRIDE_HINT =
