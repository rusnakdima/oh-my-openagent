...
This inventory tracks adapter shims that preserve old
`packages/omo-opencode/src/` and `packages/omo-codex/src/` import paths while
the implementation lives in extracted packages. These files should stay thin: a
shim re-exports from `@oh-my-opencode/*` and should not regain local logic.

Exact scan definition: a shim is a tracked `.ts` file under
`packages/omo-opencode/src` or `packages/omo-codex/src` whose first line matches
...
Snapshot date: 2026-08-25. Total shim exports found: 261.
...
| `@oh-my-opencode/hashline-core`           |            4 |
| `@oh-my-opencode/mcp-client-core`         |           21 |
| `@oh-my-opencode/model-core`              |            5 |
| `@oh-my-opencode/omo-codex`               |            1 |
| `@oh-my-opencode/omo-senpi`               |            1 |
| `@oh-my-opencode/openclaw-core`           |           30 |
| `@oh-my-opencode/rules-engine`            |            3 |
| `@oh-my-opencode/skills-loader-core`      |           59 |
| `@oh-my-opencode/team-core`               |           45 |
| `@oh-my-opencode/tmux-core`               |            3 |
| `@oh-my-opencode/utils`                   |           49 |
...
- Keep new extraction compatibility files as one-line re-export shims whenever
  possible.
- Move a shim out of this inventory only after all in-repo consumers import the
  extracted package path directly.
- Re-run the inventory scan after extraction PRs that add or remove
  compatibility files.
