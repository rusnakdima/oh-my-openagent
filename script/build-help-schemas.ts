...
const SCHEMAS: SchemaEntry[] = [
  {
    ...
    id:
      "https://raw.githubusercontent.com/code-yeongyu/oh-my-openagent/dev/assets/help/doctor.schema.json",
  },
  {
    name: "status",
    schema: StatusSchema,
    ...
    id:
      "https://raw.githubusercontent.com/code-yeongyu/oh-my-openagent/dev/assets/help/status.schema.json",
  },
  {
    name: "sandbox",
    ...
    description:
      "JSON schema for oh-my-openagent sandbox execution environment output",
    id:
      "https://raw.githubusercontent.com/code-yeongyu/oh-my-openagent/dev/assets/help/sandbox.schema.json",
  },
  {
    name: "acp",
    schema: AcpSchema,
    ...
    description:
      "JSON schema for oh-my-openagent Agent Control Protocol server output",
    id:
      "https://raw.githubusercontent.com/code-yeongyu/oh-my-openagent/dev/assets/help/acp.schema.json",
  },
];
