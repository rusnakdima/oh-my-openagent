...
describe("isExcludedReleaseNoteSubject", () => {
  test.each([
    ...
    [
      "Merge pull request #5932 from code-yeongyu/code-yeongyu/senpi-task-w3-engine",
      true,
    ],
    ...
    "#given subject %p #when exclusion is checked #then excluded is %p",
    (subject, expected) => {
      // given / when / then
