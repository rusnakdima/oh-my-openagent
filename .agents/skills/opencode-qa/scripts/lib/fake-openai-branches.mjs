...
export function selectBranch(inputStr) {
  ...
  if (isSplitProbe && !hasResult && !latches.parentToolCallIssued) {
    return "parent-tool-call";
  }
  if (
    isSplitProbe && (hasResult || latches.parentToolCallIssued) &&
    !latches.parentHoldIssued
  ) return "parent-hold";
  return "default";
}
